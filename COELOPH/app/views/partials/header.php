...
<head>
  ...
  <style>
    .navbar {
      background-color: #F0EBCE !important; /* Set background color */
    ...
    .navbar .nav-link,
    .navbar .navbar-brand {
      color: black !important; /* Ensure text color matches the overall theme */
    }
    ...
    .logout-btn {
      margin-left: 10px; /* Space between the user info and the logout button */
    }
  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="<?= ROOT ?>/assets/images/logo.png" alt="logo" style="width: 50px; height: auto;">
      </a>
